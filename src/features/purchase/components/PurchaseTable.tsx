  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100/80 overflow-hidden">
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
        <table className="w-full text-center border-collapse min-w-[1150px]" id="purchases-table-container">
          <thead>
            <tr className="border-b border-slate-200/60 text-slate-700 text-xs font-extrabold uppercase tracking-wider bg-slate-50/80">
              ...
              <th className="px-6 py-4 whitespace-nowrap text-center">{t("supplier_name")}</th>
            ...
            {filteredRecords.map((rec, idx) => (
              ...
              >
                ...
                <td className="px-6 py-4 font-bold font-sans whitespace-nowrap text-center">
                  <span className={
                    (rec.paymentStatus || "Paid") === "Paid"
                      ? "text-emerald-600"
                      : (rec.paymentStatus || "Paid") === "Pending"
                      ? "text-amber-500"
                      : "text-blue-500"
                  }>
                    {rec.paymentStatus === "Paid" ? "Completed" : rec.paymentStatus || "Completed"}
                  </span>
                </td>
                {!isPartner && (
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <div className="flex items-center justify-center space-x-1.5">
                      ...
                      <button
                        ...
                        className="p-1.5 text-slate-400 hover:text-red-650 hover:bg-red-50 rounded-lg transition cursor-pointer border border-transparent"
                        title="Delete"
                      >
                        <Trash2 size={15} />
                      </button>

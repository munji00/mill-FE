      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden border border-slate-100">
        <div className="flex items-center justify-between px-6 py-4 bg-slate-900 text-white">
          <h3 className="font-extrabold text-sm">
            {editingRecord ? "Update Sales Log" : "Log New Intake Transaction"}
          </h3>
        ...
        <form onSubmit={onSave} className="p-6 space-y-4">
          <div>
            ...
            >
              ...
              <option value="Broken Rice (Kani)">Broken Rice (Kani)</option>
              <option value="Super Fine Rice Bran">Super Fine Rice Bran</option>
              <option value="Brown Rice Bags">Brown Rice Bags</option>
              <option value="Organic Wheat Flour">Organic Wheat Flour</option>
            </select>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Punjab Rice Traders"
          ...
          <div className="bg-slate-50 p-3 rounded-lg border flex justify-between items-center text-xs">
            <span className="font-bold text-slate-500 uppercase">Estimated Total Sales:</span>
          ...
          <div className="flex justify-end space-x-3 pt-2">
            ...
            >
              {isSaving ? "Saving..." : editingRecord ? "Save Changes" : "Create Sale Log"}
            </button>
          </div>
        </form>
      </div>

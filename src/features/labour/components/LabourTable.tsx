...
export const LabourTable: React.FC<LabourTableProps> = ({
  filteredRecords,
  isPartner,
  onEdit,
  onDelete,
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100/80 overflow-hidden">
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
        <table className="w-full text-center border-collapse min-w-[1150px]" id="labour-table-container">
          <thead>
            <tr className="border-b border-slate-200/60 text-slate-700 text-xs font-extrabold uppercase tracking-wider bg-slate-50/80">
              <th className="px-6 py-4 whitespace-nowrap text-center">Name</th>
              <th className="px-6 py-4 whitespace-nowrap text-center">Role</th>
              <th className="px-6 py-4 whitespace-nowrap text-center">Daily Wage</th>
              <th className="px-6 py-4 whitespace-nowrap text-center">Present Days</th>
              <th className="px-6 py-4 whitespace-nowrap text-center">Unpaid Dues</th>
              <th className="px-6 py-4 whitespace-nowrap text-center">Contact</th>
          ...
          <tbody className="text-sm font-medium text-slate-655">
            {filteredRecords.map((rec, idx) => (
              ...
              >
                ...
                <td className="px-6 py-4 font-mono text-slate-750 whitespace-nowrap text-center">
                  {rec.presentDays} Days
                </td>
                <td className="px-6 py-4 font-mono font-bold text-slate-900 whitespace-nowrap text-center">
                  Rs.{rec.unpaidDues.toLocaleString("en-IN")}
                </td>

  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100/80 overflow-hidden">
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
        <table className="w-full text-center border-collapse min-w-[1150px]" id="expenses-table-container">
          <thead>
            <tr className="border-b border-slate-200/60 text-slate-700 text-xs font-extrabold uppercase tracking-wider bg-slate-50/80">
              ...
              <th className="px-6 py-4 whitespace-nowrap text-center">Category</th>
              <th className="px-6 py-4 whitespace-nowrap text-center">Description</th>
